...
class RNNVAESampler:
    ...
    def sample_from_mem(self, mems: np.array, method='greedy', repeat=1):
        ...
        for i, data in enumerate(data_iter):
            ...
            _repar = _repar.detach().cpu()
            gen = self.sample_from_z(_repar.numpy(), method)
    ...
    def sample_recon(self, input_smiles, varopt, method='greedy', repeat = 1):
        ...
        for i in range(repeat):
            ...
            for j, data in enumerate(data_iter):
                ...
                mols_data = batch_data.to(self.rvae.device)
                ...
                z = z.detach()
                z_list.append(z)
                gen = self.sample_from_z(z.cpu().numpy(), method=method)
