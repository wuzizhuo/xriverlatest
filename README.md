<img width="2185" height="2497" alt="Vitual" src="https://github.com/user-attachments/assets/892a6645-75ea-42f9-8baa-c18458ad5126" />
...
1.Cell self-evolve
Setting drug release to cell groups,ex:T cells ,B cells, Microglia, Astrocyte to adjust their expression via gsvaldm. And employed lrldm to generate the next ligand-receptor interaction of pre cell groups to close the target/
